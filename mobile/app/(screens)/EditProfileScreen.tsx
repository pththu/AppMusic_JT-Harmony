...
      {/* GenderSelector (Giả định GenderSelector đã hỗ trợ Dark Mode) */}
...
      {/* Nút Lưu */}
      <TouchableOpacity
        className={`rounded-full py-4 items-center mt-5 ${isChange ? 'bg-[#089b0d]' : 'bg-gray-400 dark:bg-gray-600'}`} // Nền nút disable
        onPress={() => handleSave()}
        activeOpacity={0.7}
        disabled={!isChange}
      >
        <Text className={`font-bold text-lg ${isChange ? 'text-white' : 'text-gray-200 dark:text-gray-300'}`}> 
