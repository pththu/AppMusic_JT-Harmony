...
interface LikeItemProps {
    user: { id: number; userId: number; postId: number; likedAt: string; User: UserInfo };
    onCloseModal: () => void;
}
    ...
    return (
        ...
        >
            ...
            <View className="flex-1">
                <Text className="font-bold text-base text-black dark:text-white">@{user?.User?.username}</Text>
                <Text className="text-sm text-gray-500 dark:text-gray-400">{user?.User?.fullName}</Text>
            </View>
            ...
            <View className="flex-1 justify-end bg-black/50 dark:bg-black/80">
                ...
                >
                    ...
                    <View className="flex-row justify-between items-center p-4 border-b border-gray-200 dark:border-gray-700">
                        <Text className="text-xl font-bold text-black dark:text-white">Người đã thích</Text>
                        ...
                        <FlatList
                            ...
                            ListEmptyComponent={() => (
                                <View className="p-8 items-center">
                                    <Text className="text-gray-500 dark:text-gray-400">Chưa có ai thích bài viết này.</Text>
                                </View>
                            )}
                        />
                    )}
